...
async function main() {
  ...
  await testSection(rule, 'book', PROBE.bookOld, cfg.book)
  await testSection(rule, 'toc', PROBE.tocOld, cfg.toc)
  await testSection(rule, 'content', PROBE.contentOld, cfg.content)
