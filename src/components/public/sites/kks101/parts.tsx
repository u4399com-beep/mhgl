...
// ============================================================
// [R39-2i → R51-3-c 合并] kks101 页脚(快照 .foot: 链接行 + Copyright + 友情連結)
//   注: R41 曾将页脚迁至 ./Footer.tsx 并删空本文件; 沙箱重置后本文件与 R28 代次
//   消费者(Category/Fulltext/Ranking/Read/Search/Toc)同树共存 → 按 R28 原版补齐
//   全套共享部件并与 R39 页脚段合并, KksFooter 暂无消费方, 保留留档。
// ============================================================
