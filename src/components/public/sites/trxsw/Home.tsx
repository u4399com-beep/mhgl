...
// [R43-2] x33yq(33言情 原始注释, 移植自) 克隆首页 —— 快照 /tmp/r43-snap/home.html(www.trxsw.com 直连实抓)
    ...
    <div className="trx-home">
      <div id="trx-main">
        ...
        <div id="trx-hotcontent">
          <div className="trx-l">
            {loading
              ...
              : hot6.map((b) => (
                <div className="trx-item" key={b.id}>
                  <button className="trx-image" onClick={() => go(b)} aria-label={b.name}>
        ...
        {!loading && garan.length > 0 && (
          <div className="trx-novelslist">
            <div className="trx-GARAN">
              <h2>新书排行榜(*^__^*)</h2>
              {garan.map((b) => (
                <div className="trx-top" key={b.id}>
                  <button className="trx-image" onClick={() => go(b)} aria-label={b.name}>
                    <BookCover cover={b.cover} name={b.name} />
                  </button>
                  <dl>
        ...
        {!loading && books.length > 0 && (
          <div id="trx-newscontent">
            <div className="trx-nc-l">
              <h2>最近更新小说列表</h2>
              <ul>
